...
class PlaceOrdersController extends GetxController {
  ...
  willPopScope() {
    Get.offNamedUntil(AppRoutes.createGlobalOrdersScreen, (route) => false);
  }
        ...
        ordersRequest.add(
          {
            "addressId": selectedAddress[i]["globalAddressId"] != null && selectedAddress[i]["globalAddressId"] != ""
                ...
                : selectedAddress[i]["addressId"] != null && selectedAddress[i]["addressId"] != ""
                    ...
                    : "",
            "amount": selectedAddress[i]["globalAddressId"] != null &&
                    selectedAddress[i]["globalAddressId"] != "" &&
                    edit.isNotEmpty &&
                    edit.length > i &&
                    edit[i]["_id"] == i
            ...
            "areaId": selectedAddress[i]["globalAddressId"] != null && selectedAddress[i]["globalAddressId"] != ""
                ...
                : selectedAddress[i]["addressId"] != null && selectedAddress[i]["addressId"] != ""
                    ...
                    : "",
            "billNo": selectedAddress[i]["globalAddressId"] != null &&
                    selectedAddress[i]["globalAddressId"] != "" &&
                    edit.isNotEmpty &&
                    edit.length > i &&
                    edit[i]["_id"] == i
            ...
            "businessCategoryId": selectedAddress[i]["globalAddressId"] != null && selectedAddress[i]["globalAddressId"] != ""
                ...
                : selectedAddress[i]["addressId"] != null && selectedAddress[i]["addressId"] != ""
                    ...
                    : "",
            "cash": selectedAddress[i]["globalAddressId"] != null &&
                    selectedAddress[i]["globalAddressId"] != "" &&
                    edit.isNotEmpty &&
                    edit.length > i &&
                    edit[i]["_id"] == i
                ...
                : selectedAddress[i]["cash"] != null && selectedAddress[i]["cash"] != ""
                    ...
                    : "0",
            "nOfBoxes": selectedAddress[i]["globalAddressId"] != null &&
                    selectedAddress[i]["globalAddressId"] != "" &&
                    edit.isNotEmpty &&
                    edit.length > i &&
                    edit[i]["_id"] == i
                ...
                : selectedAddress[i]["nOfBoxes"] != null && selectedAddress[i]["nOfBoxes"] != ""
                    ...
                    : "0",
            "nOfPackages": selectedAddress[i]["globalAddressId"] != null &&
                    selectedAddress[i]["globalAddressId"] != "" &&
                    edit.isNotEmpty &&
                    edit.length > i &&
                    edit[i]["_id"] == i
