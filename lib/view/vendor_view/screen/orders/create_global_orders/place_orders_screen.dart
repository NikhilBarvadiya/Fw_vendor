...
import 'package:fw_vendor/view/vendor_view/controller/place_orders_controller.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<PlaceOrdersController>(
      builder: (_) => WillPopScope(
        ...
        child: LoadingMode(
          isLoading: placeOrdersController.isLoading,
          child: Scaffold(
            appBar: AppBar(
              elevation: 1,
                            ...
                            return PlaceOrdersCard(
                              ...
                              address: e["globalAddressId"] != null && e["globalAddressId"]["address"] != ""
                                  ...
                                  : e["addressId"]["address"] != null && e["addressId"]["address"] != ""
                                      ...
                                      : "",
                              billNo: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ? placeOrdersController.edit[index]["billNo"].toString()
                                  : e["billNo"] != null && e["billNo"] != ""
                                      ? e["billNo"].toString()
                                      : "",
                              type: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ...
                                  : e["type"] != null && e["type"] != ""
                                      ...
                                      : "credit",
                              amount: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ...
                                  : e["cash"] != null && e["cash"] != ""
                                      ? e["cash"].toString()
                                      : "0",
                              billAmount: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ...
                                  : e["amount"] != null && e["amount"] != ""
                                      ? e["amount"].toString()
                                      : "0",
                              notes: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ...
                                  : e["anyNote"] != null && e["anyNote"] != ""
                                      ? e["anyNote"].toString()
                                      : "___",
                              loose: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
                                  ...
                                  : e["nOfPackages"] != null && e["nOfPackages"] != ""
                                      ...
                                      : "0",
                              box: placeOrdersController.edit.isNotEmpty &&
                                      placeOrdersController.edit.length > index &&
                                      placeOrdersController.edit[index]["_id"] == index
