  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(
      builder: (_) => WillPopScope(
        ...
        child: LoadingMode(
          isLoading: chatController.isLoading && chatController.allChatList.isEmpty,
          child: Scaffold(
            appBar: AppBar(
              elevation: 1,
            ...
            body: Stack(
              children: [
                            ...
                            ? ChatBubble(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      if (chatController.allChatList[index]["messageType"] == "text" &&
                                      ...
                                      if (chatController.allChatList[index]["messageType"] == "image" &&
                                          chatController.allChatList[index]["message"] != "")
                                        SizedBox(
                                          height: 130,
                                          width: 130,
                                      ...
                                      if (chatController.allChatList[index]["messageType"] == "file" ||
                ...
                Align(
                  ...
                  child: Card(
                    ...
                    child: Row(
                      children: [
                        SpeedDial(
                          onOpen: () => chatController.txtMessageFocus.unfocus(),
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            focusNode: chatController.txtMessageFocus,
                ...
                if (chatController.allChatList.isEmpty && !chatController.isLoading)
                  Column(
