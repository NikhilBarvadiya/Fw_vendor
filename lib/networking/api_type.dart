...
class ApiMethods {
  ...
  final String setOrderTicket = "vendor/set/orderTicket";
  final String getOrderTicket = "vendor/get/orderTicket";
  final String updateOrderTicket = "vendor/update/orderTicket";
  final String getActivityOrderTicket = "vendor/getActivity/orderTicket";
  final String getOrderDetailsOrderTicket = "vendor/getOrderDetails/orderTicket";
  final String getReturnOrderDetails = "vendor/get/returnOrderDetails";
  final String statisticsOrderPackagesDetails = "vendor/statistics/orderPackagesDetails";
  ...
  final String addRequest = "vendorEmployee/setScanData/addRequest";
